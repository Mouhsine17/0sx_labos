...
public:
  ...
  // Impose une vitesse reçue par MQTT (seulement si actif)
  // À appeler depuis l'extérieur après vérification estEnFonction()
  void setVitesseMqtt(int vitesse) {
    _vitesseConst = vitesse;
    _vitesse      = vitesse;
