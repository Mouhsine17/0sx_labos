...
// Convoyeur - moteur DC via L293D (2 broches PWM, EN1 cable sur 5V)
...
void onSimpleClic() {
  ...
  switch (etatCourant) {
    case LUM_DIST:    etatCourant = DHT_STATE; break;
    case DHT_STATE:   etatCourant = LUM_DIST; break;
    case CALIBRATION: etatCourant = DHT_STATE; break;
    case ETAT_VANNE:  etatCourant = DHT_STATE; break;
    default: break;
  }
}
...
void afficherLCD() {
  ...
  switch (etatCourant) {
    case LUM_DIST:
      ...
      lcd.setCursor(0, 0);
      lcd.print("Lum : "); lcd.print(lumPct); lcd.print("%   ");
      lcd.setCursor(0, 1);
    ...
    case DHT_STATE:
      ...
      lcd.setCursor(0, 1);
      lcd.print("Hum : "); lcd.print(humidite, 1); lcd.print(" %   ");
      break;
    ...
    case CALIBRATION:
      ...
      if (refresh) lcd.clear();
      lcd.setCursor(0, 0);
      lcd.print("Lum min : "); lcd.print(lumMin); lcd.print("   ");
      lcd.setCursor(0, 1);
      lcd.print("Lum max : "); lcd.print(lumMax); lcd.print("   ");
      break;

    case ETAT_VANNE: {
      if (refresh) lcd.clear();
      lcd.setCursor(0, 0);
      lcd.print("Vanne : "); lcd.print(vannePct); lcd.print("%   ");
      lcd.setCursor(0, 1);
      lcd.print("Etat : ");
      switch (etatVanne) {
